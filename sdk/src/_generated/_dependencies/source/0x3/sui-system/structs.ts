...
export function isSuiSystemState(type: string): boolean {
  ...
  return type === `${PKG_V15}::sui_system::SuiSystemState`;
}
...
export class SuiSystemState implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::sui_system::SuiSystemState`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = SuiSystemState.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::sui_system::SuiSystemState`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: SuiSystemStateFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::sui_system::SuiSystemState`;
