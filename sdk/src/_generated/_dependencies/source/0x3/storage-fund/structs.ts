...
export function isStorageFund(type: string): boolean {
  ...
  return type === `${PKG_V16}::storage_fund::StorageFund`;
}
...
export class StorageFund implements StructClass {
  ...
  static readonly $typeName = `${PKG_V16}::storage_fund::StorageFund`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = StorageFund.$typeName;
  readonly $fullTypeName: `${typeof PKG_V16}::storage_fund::StorageFund`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: StorageFundFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V16}::storage_fund::StorageFund`;
