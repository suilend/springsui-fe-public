...
export class ValidatorSet implements StructClass {
  ...
  static reified(): ValidatorSetReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        ValidatorSet.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof ValidatorSet.instantiateBcs
  > | null = null;
...
export class ValidatorEpochInfoEvent implements StructClass {
  ...
  static reified(): ValidatorEpochInfoEventReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        ValidatorEpochInfoEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof ValidatorEpochInfoEvent.instantiateBcs
  > | null = null;

  static get bcs() {
    if (!ValidatorEpochInfoEvent.cachedBcs) {
      ValidatorEpochInfoEvent.cachedBcs =
        ValidatorEpochInfoEvent.instantiateBcs();
    }
...
export class ValidatorEpochInfoEventV2 implements StructClass {
  ...
  static reified(): ValidatorEpochInfoEventV2Reified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        ValidatorEpochInfoEventV2.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
      fromJSONField: (field: any) =>
  ...
  private static cachedBcs: ReturnType<
    typeof ValidatorEpochInfoEventV2.instantiateBcs
  > | null = null;

  static get bcs() {
    if (!ValidatorEpochInfoEventV2.cachedBcs) {
      ValidatorEpochInfoEventV2.cachedBcs =
        ValidatorEpochInfoEventV2.instantiateBcs();
    }
...
export class ValidatorJoinEvent implements StructClass {
  ...
  static reified(): ValidatorJoinEventReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        ValidatorJoinEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof ValidatorJoinEvent.instantiateBcs
  > | null = null;
...
export class ValidatorLeaveEvent implements StructClass {
  ...
  static reified(): ValidatorLeaveEventReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        ValidatorLeaveEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof ValidatorLeaveEvent.instantiateBcs
  > | null = null;
