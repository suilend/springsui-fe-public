...
export function isValidatorEpochInfoEvent(type: string): boolean {
  ...
  return type === `${PKG_V15}::validator_set::ValidatorEpochInfoEvent`;
}
...
export class ValidatorEpochInfoEvent implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::validator_set::ValidatorEpochInfoEvent`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ValidatorEpochInfoEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::validator_set::ValidatorEpochInfoEvent`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ValidatorEpochInfoEventFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::validator_set::ValidatorEpochInfoEvent`;
...
export function isValidatorEpochInfoEventV2(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::validator_set::ValidatorEpochInfoEventV2`;
}
...
export class ValidatorEpochInfoEventV2 implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::validator_set::ValidatorEpochInfoEventV2`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ValidatorEpochInfoEventV2.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::validator_set::ValidatorEpochInfoEventV2`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ValidatorEpochInfoEventV2Fields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::validator_set::ValidatorEpochInfoEventV2`;
    this.$typeArgs = typeArgs;
...
export function isValidatorJoinEvent(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::validator_set::ValidatorJoinEvent`;
}
...
export class ValidatorJoinEvent implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::validator_set::ValidatorJoinEvent`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ValidatorJoinEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::validator_set::ValidatorJoinEvent`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ValidatorJoinEventFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::validator_set::ValidatorJoinEvent`;
    this.$typeArgs = typeArgs;
...
export function isValidatorLeaveEvent(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::validator_set::ValidatorLeaveEvent`;
}
...
export class ValidatorLeaveEvent implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::validator_set::ValidatorLeaveEvent`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ValidatorLeaveEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::validator_set::ValidatorLeaveEvent`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ValidatorLeaveEventFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::validator_set::ValidatorLeaveEvent`;
    this.$typeArgs = typeArgs;
...
export function isValidatorSet(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::validator_set::ValidatorSet`;
}
...
export class ValidatorSet implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::validator_set::ValidatorSet`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ValidatorSet.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::validator_set::ValidatorSet`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ValidatorSetFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::validator_set::ValidatorSet`;
    this.$typeArgs = typeArgs;
