...
export function isValidatorWrapper(type: string): boolean {
  ...
  return type === `${PKG_V16}::validator_wrapper::ValidatorWrapper`;
}
...
export class ValidatorWrapper implements StructClass {
  ...
  static readonly $typeName = `${PKG_V16}::validator_wrapper::ValidatorWrapper`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ValidatorWrapper.$typeName;
  readonly $fullTypeName: `${typeof PKG_V16}::validator_wrapper::ValidatorWrapper`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ValidatorWrapperFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V16}::validator_wrapper::ValidatorWrapper`;
