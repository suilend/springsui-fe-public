...
export class StakingPool implements StructClass {
  ...
  static reified(): StakingPoolReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        StakingPool.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof StakingPool.instantiateBcs
  > | null = null;
...
export class PoolTokenExchangeRate implements StructClass {
  ...
  static reified(): PoolTokenExchangeRateReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        PoolTokenExchangeRate.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof PoolTokenExchangeRate.instantiateBcs
  > | null = null;
...
export class StakedSui implements StructClass {
  ...
  static reified(): StakedSuiReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        StakedSui.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<typeof StakedSui.instantiateBcs> | null =
    null;
...
export class FungibleStakedSui implements StructClass {
  ...
  static reified(): FungibleStakedSuiReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        FungibleStakedSui.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof FungibleStakedSui.instantiateBcs
  > | null = null;
...
export class FungibleStakedSuiData implements StructClass {
  ...
  static reified(): FungibleStakedSuiDataReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        FungibleStakedSuiData.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof FungibleStakedSuiData.instantiateBcs
  > | null = null;
...
export class FungibleStakedSuiDataKey implements StructClass {
  ...
  static reified(): FungibleStakedSuiDataKeyReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        FungibleStakedSuiDataKey.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof FungibleStakedSuiDataKey.instantiateBcs
  > | null = null;

  static get bcs() {
    if (!FungibleStakedSuiDataKey.cachedBcs) {
      FungibleStakedSuiDataKey.cachedBcs =
        FungibleStakedSuiDataKey.instantiateBcs();
    }
