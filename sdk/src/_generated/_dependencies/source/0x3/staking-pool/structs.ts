...
export function isFungibleStakedSui(type: string): boolean {
  ...
  return type === `${PKG_V15}::staking_pool::FungibleStakedSui`;
}
...
export class FungibleStakedSui implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::staking_pool::FungibleStakedSui`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = FungibleStakedSui.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::staking_pool::FungibleStakedSui`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: FungibleStakedSuiFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::staking_pool::FungibleStakedSui`;
...
export function isFungibleStakedSuiData(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::staking_pool::FungibleStakedSuiData`;
}
...
export class FungibleStakedSuiData implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::staking_pool::FungibleStakedSuiData`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = FungibleStakedSuiData.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::staking_pool::FungibleStakedSuiData`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: FungibleStakedSuiDataFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::staking_pool::FungibleStakedSuiData`;
    this.$typeArgs = typeArgs;
...
export function isFungibleStakedSuiDataKey(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::staking_pool::FungibleStakedSuiDataKey`;
}
...
export class FungibleStakedSuiDataKey implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::staking_pool::FungibleStakedSuiDataKey`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = FungibleStakedSuiDataKey.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::staking_pool::FungibleStakedSuiDataKey`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: FungibleStakedSuiDataKeyFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::staking_pool::FungibleStakedSuiDataKey`;
    this.$typeArgs = typeArgs;
  ...
  static reified(): FungibleStakedSuiDataKeyReified {
    return {
      ...
      reifiedTypeArgs: [],
      fromFields: (fields: Record<string, any>) =>
        FungibleStakedSuiDataKey.fromFields(fields),
      fromFieldsWithTypes: (item: FieldsWithTypes) =>
      ...
      fromJSONField: (field: any) =>
        FungibleStakedSuiDataKey.fromJSONField(field),
      fromJSON: (json: Record<string, any>) =>
        FungibleStakedSuiDataKey.fromJSON(json),
      fromSuiParsedData: (content: SuiParsedData) =>
        FungibleStakedSuiDataKey.fromSuiParsedData(content),
      fromSuiObjectData: (content: SuiObjectData) =>
        FungibleStakedSuiDataKey.fromSuiObjectData(content),
      fetch: async (client: SuiClient, id: string) =>
        FungibleStakedSuiDataKey.fetch(client, id),
  ...
  static fromBcs(data: Uint8Array): FungibleStakedSuiDataKey {
    return FungibleStakedSuiDataKey.fromFields(
      FungibleStakedSuiDataKey.bcs.parse(data),
    );
  }
  ...
  static async fetch(
    client: SuiClient,
    id: string,
  ): Promise<FungibleStakedSuiDataKey> {
    const res = await client.getObject({ id, options: { showBcs: true } });
    if (res.error) {
      throw new Error(
    ...
    if (
      ...
      throw new Error(
        `object at id ${id} is not a FungibleStakedSuiDataKey object`,
      );
    }
...
export function isPoolTokenExchangeRate(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::staking_pool::PoolTokenExchangeRate`;
}
...
export class PoolTokenExchangeRate implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::staking_pool::PoolTokenExchangeRate`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = PoolTokenExchangeRate.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::staking_pool::PoolTokenExchangeRate`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: PoolTokenExchangeRateFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::staking_pool::PoolTokenExchangeRate`;
    this.$typeArgs = typeArgs;
...
export function isStakedSui(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::staking_pool::StakedSui`;
}
...
export class StakedSui implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::staking_pool::StakedSui`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = StakedSui.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::staking_pool::StakedSui`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: StakedSuiFields) {
    this.$fullTypeName = composeSuiType(
      StakedSui.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V15}::staking_pool::StakedSui`;
    this.$typeArgs = typeArgs;
...
export function isStakingPool(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::staking_pool::StakingPool`;
}
...
export class StakingPool implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::staking_pool::StakingPool`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = StakingPool.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::staking_pool::StakingPool`;
  readonly $typeArgs: [];
  ...
  readonly exchangeRates: ToField<
    Table<"u64", ToPhantom<PoolTokenExchangeRate>>
  >;
  ...
  private constructor(typeArgs: [], fields: StakingPoolFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::staking_pool::StakingPool`;
    this.$typeArgs = typeArgs;
  ...
  static fromFields(fields: Record<string, any>): StakingPool {
    return StakingPool.reified().new({
      ...
      exchangeRates: decodeFromFields(
        Table.reified(
          reified.phantom("u64"),
          reified.phantom(PoolTokenExchangeRate.reified()),
        ),
