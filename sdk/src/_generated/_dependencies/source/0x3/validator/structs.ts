...
export class ValidatorMetadata implements StructClass {
  ...
  static reified(): ValidatorMetadataReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        ValidatorMetadata.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof ValidatorMetadata.instantiateBcs
  > | null = null;
...
export class Validator implements StructClass {
  ...
  static reified(): ValidatorReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        Validator.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<typeof Validator.instantiateBcs> | null =
    null;
...
export class StakingRequestEvent implements StructClass {
  ...
  static reified(): StakingRequestEventReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        StakingRequestEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof StakingRequestEvent.instantiateBcs
  > | null = null;
...
export class UnstakingRequestEvent implements StructClass {
  ...
  static reified(): UnstakingRequestEventReified {
    ...
    return {
      ...
      fromBcs: (data: Uint8Array) =>
        UnstakingRequestEvent.fromFields(reifiedBcs.parse(data)),
      bcs: reifiedBcs,
  ...
  private static cachedBcs: ReturnType<
    typeof UnstakingRequestEvent.instantiateBcs
  > | null = null;
...
export class RedeemingFungibleStakedSuiEvent implements StructClass {
  ...
  static get bcs() {
    if (!RedeemingFungibleStakedSuiEvent.cachedBcs) {
      RedeemingFungibleStakedSuiEvent.cachedBcs =
        RedeemingFungibleStakedSuiEvent.instantiateBcs();
    }
