...
export function isConvertingToFungibleStakedSuiEvent(type: string): boolean {
  ...
  return type === `${PKG_V16}::validator::ConvertingToFungibleStakedSuiEvent`;
}
...
export class ConvertingToFungibleStakedSuiEvent implements StructClass {
  ...
  static readonly $typeName = `${PKG_V16}::validator::ConvertingToFungibleStakedSuiEvent`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ConvertingToFungibleStakedSuiEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V16}::validator::ConvertingToFungibleStakedSuiEvent`;
  readonly $typeArgs: [];
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V16}::validator::ConvertingToFungibleStakedSuiEvent`;
...
export function isRedeemingFungibleStakedSuiEvent(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V16}::validator::RedeemingFungibleStakedSuiEvent`;
}
...
export class RedeemingFungibleStakedSuiEvent implements StructClass {
  ...
  static readonly $typeName = `${PKG_V16}::validator::RedeemingFungibleStakedSuiEvent`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = RedeemingFungibleStakedSuiEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V16}::validator::RedeemingFungibleStakedSuiEvent`;
  readonly $typeArgs: [];
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V16}::validator::RedeemingFungibleStakedSuiEvent`;
    this.$typeArgs = typeArgs;
...
export function isStakingRequestEvent(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V16}::validator::StakingRequestEvent`;
}
...
export class StakingRequestEvent implements StructClass {
  ...
  static readonly $typeName = `${PKG_V16}::validator::StakingRequestEvent`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = StakingRequestEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V16}::validator::StakingRequestEvent`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: StakingRequestEventFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V16}::validator::StakingRequestEvent`;
    this.$typeArgs = typeArgs;
...
export function isUnstakingRequestEvent(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V16}::validator::UnstakingRequestEvent`;
}
...
export class UnstakingRequestEvent implements StructClass {
  ...
  static readonly $typeName = `${PKG_V16}::validator::UnstakingRequestEvent`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = UnstakingRequestEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V16}::validator::UnstakingRequestEvent`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: UnstakingRequestEventFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V16}::validator::UnstakingRequestEvent`;
    this.$typeArgs = typeArgs;
...
export function isValidator(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V16}::validator::Validator`;
}
...
export class Validator implements StructClass {
  ...
  static readonly $typeName = `${PKG_V16}::validator::Validator`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = Validator.$typeName;
  readonly $fullTypeName: `${typeof PKG_V16}::validator::Validator`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ValidatorFields) {
    this.$fullTypeName = composeSuiType(
      Validator.$typeName,
      ...typeArgs,
    ) as `${typeof PKG_V16}::validator::Validator`;
    this.$typeArgs = typeArgs;
...
export function isValidatorMetadata(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V16}::validator::ValidatorMetadata`;
}
...
export class ValidatorMetadata implements StructClass {
  ...
  static readonly $typeName = `${PKG_V16}::validator::ValidatorMetadata`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ValidatorMetadata.$typeName;
  readonly $fullTypeName: `${typeof PKG_V16}::validator::ValidatorMetadata`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ValidatorMetadataFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V16}::validator::ValidatorMetadata`;
    this.$typeArgs = typeArgs;
