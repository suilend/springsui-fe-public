...
export function isSuiSystemStateInner(type: string): boolean {
  ...
  return type === `${PKG_V15}::sui_system_state_inner::SuiSystemStateInner`;
}
...
export class SuiSystemStateInner implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::sui_system_state_inner::SuiSystemStateInner`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = SuiSystemStateInner.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::sui_system_state_inner::SuiSystemStateInner`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: SuiSystemStateInnerFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::sui_system_state_inner::SuiSystemStateInner`;
...
export function isSuiSystemStateInnerV2(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::sui_system_state_inner::SuiSystemStateInnerV2`;
}
...
export class SuiSystemStateInnerV2 implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::sui_system_state_inner::SuiSystemStateInnerV2`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = SuiSystemStateInnerV2.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::sui_system_state_inner::SuiSystemStateInnerV2`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: SuiSystemStateInnerV2Fields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::sui_system_state_inner::SuiSystemStateInnerV2`;
    this.$typeArgs = typeArgs;
...
export function isSystemEpochInfoEvent(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::sui_system_state_inner::SystemEpochInfoEvent`;
}
...
export class SystemEpochInfoEvent implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::sui_system_state_inner::SystemEpochInfoEvent`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = SystemEpochInfoEvent.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::sui_system_state_inner::SystemEpochInfoEvent`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: SystemEpochInfoEventFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::sui_system_state_inner::SystemEpochInfoEvent`;
    this.$typeArgs = typeArgs;
...
export function isSystemParameters(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::sui_system_state_inner::SystemParameters`;
}
...
export class SystemParameters implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::sui_system_state_inner::SystemParameters`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = SystemParameters.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::sui_system_state_inner::SystemParameters`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: SystemParametersFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::sui_system_state_inner::SystemParameters`;
    this.$typeArgs = typeArgs;
...
export function isSystemParametersV2(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::sui_system_state_inner::SystemParametersV2`;
}
...
export class SystemParametersV2 implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::sui_system_state_inner::SystemParametersV2`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = SystemParametersV2.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::sui_system_state_inner::SystemParametersV2`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: SystemParametersV2Fields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::sui_system_state_inner::SystemParametersV2`;
    this.$typeArgs = typeArgs;
