...
export function isUnverifiedValidatorOperationCap(type: string): boolean {
  ...
  return type === `${PKG_V15}::validator_cap::UnverifiedValidatorOperationCap`;
}
...
export class UnverifiedValidatorOperationCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::validator_cap::UnverifiedValidatorOperationCap`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = UnverifiedValidatorOperationCap.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::validator_cap::UnverifiedValidatorOperationCap`;
  readonly $typeArgs: [];
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::validator_cap::UnverifiedValidatorOperationCap`;
...
export function isValidatorOperationCap(type: string): boolean {
  type = compressSuiType(type);
  return type === `${PKG_V15}::validator_cap::ValidatorOperationCap`;
}
...
export class ValidatorOperationCap implements StructClass {
  ...
  static readonly $typeName = `${PKG_V15}::validator_cap::ValidatorOperationCap`;
  static readonly $numTypeParams = 0;
  static readonly $isPhantom = [] as const;

  readonly $typeName = ValidatorOperationCap.$typeName;
  readonly $fullTypeName: `${typeof PKG_V15}::validator_cap::ValidatorOperationCap`;
  readonly $typeArgs: [];
  ...
  private constructor(typeArgs: [], fields: ValidatorOperationCapFields) {
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V15}::validator_cap::ValidatorOperationCap`;
    this.$typeArgs = typeArgs;
