...
export default function BottomNav() {
  ...
  return (
    <>
      {/* WIDTH < md */}
      <div
        className="fixed inset-x-0 bottom-0 z-[2] flex w-full flex-row items-center rounded-t-lg bg-white px-6 py-3.5 shadow-sm outline outline-navy-200/25 md:hidden"
